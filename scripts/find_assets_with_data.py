...
CANDIDATE_ASSETS = [
    ...
    "ORCL", "ADBE", "CSCO", "AVGO", "TXN", "QCOM", "NOW", "INTU", "AMAT", "MU",
    # Finance
    "JPM", "BAC", "WFC", "C", "GS", "MS", "BLK", "SCHW", "AXP", "COF",
    "USB", "PNC", "TFC", "BK", "STT", "CFG", "HBAN", "KEY", "MTB", "ZION",
    # Healthcare
    "JNJ", "UNH", "PFE", "ABT", "TMO", "ABBV", "MRK", "BMY", "AMGN", "GILD",
    "CVS", "CI", "HUM", "CNC", "ELV", "HCA", "DVA", "UHS", "THC", "ENSG",
    # Consumer
    "WMT", "HD", "MCD", "NKE", "SBUX", "TGT", "LOW", "TJX", "DG", "COST",
    "BBY", "ROST", "DLTR", "FIVE", "OLLI", "DKS", "ASO", "BGS", "CASY", "BJ",
    # Industrial
    "BA", "CAT", "GE", "HON", "RTX", "LMT", "NOC", "GD", "TDG", "TXT",
    "EMR", "ETN", "ITW", "PH", "ROK", "SWK", "DOV", "GGG", "AOS", "FAST",
    # Energy
    "XOM", "CVX", "SLB", "EOG", "COP", "MPC", "VLO", "PSX", "HES", "FANG",
    "OVV", "CTRA", "MRO", "APA", "DVN", "PR", "SWN", "MTDR", "SM", "NOG",
    # Materials
    "LIN", "APD", "ECL", "SHW", "DD", "PPG", "FCX", "NEM", "DOW", "VMC",
    "FMC", "CF", "MOS", "NTR", "IP", "PKG", "WRK", "SEE", "AVY", "SLGN",
    # Utilities
    "NEE", "DUK", "SO", "D", "AEP", "SRE", "EXC", "XEL", "WEC", "ES",
    "PEG", "ETR", "FE", "AEE", "CMS", "LNT", "ATO", "CNP", "NI", "OGE",
    # Real Estate
    "AMT", "PLD", "EQIX", "PSA", "WELL", "VICI", "SPG", "O", "EXPI", "CBRE",
    "IRM", "AVB", "EQR", "MAA", "UDR", "ESS", "CPT", "AIRC", "INVH", "SUI",
    # Communication
    "VZ", "T", "TMUS", "CMCSA", "DIS", "NFLX", "PARA", "FOX", "FOXA", "WBD",
    # Consumer Staples
